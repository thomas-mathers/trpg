...
internal static class JobGenerator {
    ...
    public static Job GenerateSleep(Guid stateId, Guid personId, Guid roomId, Guid worldId) => new() {
        StateId = stateId, PersonId = personId, Action = JobAction.Sleep,
        StartHour = SleepStartHour, EndHour = SleepEndHour, Daily = true, Priority = 100, RoomId = roomId, WorldId = worldId
    };

    public static Job GenerateIdle(Guid stateId, Guid personId, Guid? roomId, Guid worldId) => new() {
        StateId = stateId, PersonId = personId, Action = JobAction.Idle,
        StartHour = IdleStartHour, EndHour = IdleEndHour, Daily = true, Priority = 0, RoomId = roomId, WorldId = worldId
    };

    public static Job GenerateWork(Guid stateId, Guid personId, Guid roomId, Guid worldId) => new() {
        StateId = stateId, PersonId = personId, Action = JobAction.Work,
        StartHour = WorkStartHour, EndHour = WorkEndHour, Daily = true, Priority = 50, RoomId = roomId, WorldId = worldId
    };
