...
) : IQueryHandler<GetDungeonConversationKnowledgeQuery, DungeonConversationKnowledge?>
{
    ...
    )
    {
        ...
        var npcFacts = await getKnownFacts.Handle(
            new GetKnownFactIdsQuery(WorldId: query.WorldId, KnowerId: query.NpcId),
            cancellationToken
        );
        ...
        return new DungeonConversationKnowledge(
            ...
            npcFacts.Contains(expedition.DiscoveryFactId) ? expedition.Discovery : null,
