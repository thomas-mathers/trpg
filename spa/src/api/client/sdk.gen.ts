...
export const devGenerateQuestChain = <ThrowOnError extends boolean = false>(options: Options<DevGenerateQuestChainData, ThrowOnError>): RequestResult<DevGenerateQuestChainResponses, unknown, ThrowOnError> => (options.client ?? client).post<DevGenerateQuestChainResponses, unknown, ThrowOnError>({ url: '/dev/quest-chains/generate', ...options });
