...
namespace TRPG.Migrations
{
    ...
    [Migration("20260701003757_DropBuildingNameUniqueConstraint")]
    partial class DropBuildingNameUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRPG.Models.Building", b =>
                {
                    ...
                    b.HasIndex("RegionId", "Name")
                        .HasDatabaseName("ix_buildings_region_id_name");
            ...
            modelBuilder.Entity("TRPG.Models.Person", b =>
                {
                    ...
                    b.Property<Guid>("BirthRegionId")
                        .HasColumnType("uuid")
                        .HasColumnName("birth_region_id");
            ...
            modelBuilder.Entity("TRPG.Models.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CountryId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_regions_country_id_name");
            ...
            modelBuilder.Entity("TRPG.Models.Road", b =>
                {
                    ...
                    b.Property<Guid>("DestinationRegionId")
                        .HasColumnType("uuid")
                        .HasColumnName("destination_region_id");
                    ...
                    b.Property<Guid>("OriginRegionId")
                        .HasColumnType("uuid")
                        .HasColumnName("origin_region_id");
                    ...
                    b.HasIndex("OriginRegionId", "DestinationRegionId")
                        .IsUnique()
                        .HasDatabaseName("ix_roads_origin_region_id_destination_region_id");
                    ...
                    b.OwnsOne("TRPG.Models.Location", "Location", b1 =>
                        {
                            ...
                            b1.Property<Guid?>("RegionId")
                                .HasColumnType("uuid")
                                .HasColumnName("location_region_id");
                            ...
                            b1.HasIndex("RegionId", "BuildingId")
                                .HasDatabaseName("ix_jobs_location_region_id_location_building_id");
                    ...
                    b.OwnsOne("TRPG.Models.Location", "Location", b1 =>
                        {
                            ...
                            b1.HasIndex("RegionId", "BuildingId")
                                .HasDatabaseName("ix_persons_location_region_id_location_building_id");
                    ...
                    b.OwnsOne("TRPG.Models.Polygon", "Boundary", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_regions_regions_id");

                            b1.OwnsMany("TRPG.Models.Point", "Points", b2 =>
                                {
                                    b2.Property<Guid>("PolygonRegionId");
                                    ...
                                    b2.HasKey("PolygonRegionId", "__synthesizedOrdinal");

                                    b2.ToTable("regions");

                                    b2.WithOwner()
                                        .HasForeignKey("PolygonRegionId")
                                        .HasConstraintName("fk_regions_regions_polygon_region_id");
                                });
