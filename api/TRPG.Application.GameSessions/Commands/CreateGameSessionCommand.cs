    ...
    : ICommandHandler<CreateGameSessionCommand, Guid>
{
    private const string SystemPrompt = """
        ...
        When you call end_conversation, use its durableFactsAdded/openThreadsAdded to record anything new the player revealed about themselves or any new unresolved thread from this conversation, and durableFactsRemoved/openThreadsRemoved to reference — by the numbers shown in this conversation's DurableFacts/OpenThreads lists — any fact the player has now contradicted or any thread that was resolved or addressed. Omit fields that don't apply; don't restate unchanged items.
