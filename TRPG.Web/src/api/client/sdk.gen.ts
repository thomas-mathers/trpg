...
export const getPlayersByPlayerIdFight = <ThrowOnError extends boolean = false>(options: Options<GetPlayersByPlayerIdFightData, ThrowOnError>): RequestResult<GetPlayersByPlayerIdFightResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetPlayersByPlayerIdFightResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/fight', ...options });
...
export const postSessions = <ThrowOnError extends boolean = false>(options: Options<PostSessionsData, ThrowOnError>): RequestResult<PostSessionsResponses, unknown, ThrowOnError> => (options.client ?? client).post<PostSessionsResponses, unknown, ThrowOnError>({ url: '/sessions', ...options });

export const getSessionsBySessionIdScene = <ThrowOnError extends boolean = false>(options: Options<GetSessionsBySessionIdSceneData, ThrowOnError>): RequestResult<GetSessionsBySessionIdSceneResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetSessionsBySessionIdSceneResponses, unknown, ThrowOnError>({ url: '/sessions/{sessionId}/scene', ...options });
...
export const getJobsById = <ThrowOnError extends boolean = false>(options: Options<GetJobsByIdData, ThrowOnError>): RequestResult<GetJobsByIdResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetJobsByIdResponses, unknown, ThrowOnError>({ url: '/jobs/{id}', ...options });
