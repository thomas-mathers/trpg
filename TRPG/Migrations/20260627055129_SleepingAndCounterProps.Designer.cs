...
namespace TRPG.Migrations
{
    ...
    [Migration("20260627055129_SleepingAndCounterProps")]
    partial class SleepingAndCounterProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRPG.Models.CounterProp", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.HasDiscriminator().HasValue("CounterProp");
                });
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("OccupantId")
                                .HasColumnName("seat_prop_occupant_id");
                        });

                    b.HasDiscriminator().HasValue("SeatProp");
                });

            modelBuilder.Entity("TRPG.Models.SleepingProp", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("AssignedPersonId")
                                .HasColumnName("sleeping_prop_assigned_person_id");

                            t.Property("OccupantId")
                                .HasColumnName("sleeping_prop_occupant_id");
                        });

                    b.HasDiscriminator().HasValue("SleepingProp");
                });
            ...
            modelBuilder.Entity("TRPG.Models.WorkstationProp", b =>
                {
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("AssignedPersonId")
                                .HasColumnName("workstation_prop_assigned_person_id");
