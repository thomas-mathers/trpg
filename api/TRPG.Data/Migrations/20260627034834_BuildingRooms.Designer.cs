...
namespace TRPG.Migrations
{
    ...
    [Migration("20260627034834_BuildingRooms")]
    partial class BuildingRooms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRPG.Models.Prop", b =>
                {
                    ...
                    b.HasDiscriminator<string>("prop_type").HasValue("Prop");
            ...
            modelBuilder.Entity("TRPG.Models.Altar", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");

                    b.ToTable("props", (string)null);

                    b.HasDiscriminator().HasValue("Altar");
                });

            modelBuilder.Entity("TRPG.Models.Barrel", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");

                    b.ToTable("props", (string)null);

                    b.HasDiscriminator().HasValue("Barrel");
                });
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("AssignedPersonId")
                                .HasColumnName("bed_assigned_person_id");
                        });

                    b.HasDiscriminator().HasValue("Bed");
                });

            modelBuilder.Entity("TRPG.Models.Bookcase", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");

                    b.ToTable("props", (string)null);

                    b.HasDiscriminator().HasValue("Bookcase");
                });

            modelBuilder.Entity("TRPG.Models.Chair", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("OccupantId")
                                .HasColumnName("chair_occupant_id");
                        });

                    b.HasDiscriminator().HasValue("Chair");
                });

            modelBuilder.Entity("TRPG.Models.Chest", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("KeyItemId")
                                .HasColumnName("chest_key_item_id");
                        });

                    b.HasDiscriminator().HasValue("Chest");
                });

            modelBuilder.Entity("TRPG.Models.Counter", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
            ...
            modelBuilder.Entity("TRPG.Models.Door", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
            ...
            modelBuilder.Entity("TRPG.Models.Fireplace", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
            ...
            modelBuilder.Entity("TRPG.Models.Forge", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.HasDiscriminator().HasValue("Forge");
                });

            modelBuilder.Entity("TRPG.Models.Lever", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
            ...
            modelBuilder.Entity("TRPG.Models.Staircase", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
                    ...
                    b.ToTable("props", null, t =>
                        {
                            t.Property("DestinationRoomId")
                                .HasColumnName("staircase_destination_room_id");
                        });

                    b.HasDiscriminator().HasValue("Staircase");
                });

            modelBuilder.Entity("TRPG.Models.Table", b =>
                {
                    b.HasBaseType("TRPG.Models.Prop");
