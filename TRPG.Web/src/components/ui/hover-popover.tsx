...
function HoverPopoverContent({
  ...
  const contentClassName = cn(
    'bg-foreground text-background z-50 w-fit max-w-64 rounded-md px-3 py-1.5 text-xs shadow-md outline-hidden duration-100 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95',
    className,
  );
