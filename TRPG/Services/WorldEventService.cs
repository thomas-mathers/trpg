...
public class WorldEventService(TrpgDbContext context)
{
    ...
    public async Task<List<WorldEvent>> GetAllByRegion(Circle region, CancellationToken cancellationToken = default)
    {
