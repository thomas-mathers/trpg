...
public sealed class ReputationServiceTests(DatabaseFixture db) : IAsyncLifetime
{
    ...
    {
        // Act
        await _service.AdjustReputation(
            _creatureId,
            _faction.Id,
        ...
        // Assert
        var reputations = await _service.GetAllByCreatureId(
            _creatureId,
            TestContext.Current.CancellationToken
        );
    ...
    public async Task GetAllByCreatureId_ReturnsReputationsForCreature()
    {
        ...
        // Act
        var result = await _service.GetAllByCreatureId(
            creatureId,
            TestContext.Current.CancellationToken
        );
    ...
    public async Task GetEffectiveReputation_ReturnsZero_WhenNoReputationHistory()
    {
        ...
        // Act
        var result = await _service.GetEffectiveReputation(
            _creatureId,
            npc.Id,
            TestContext.Current.CancellationToken
        );
    ...
    {
        // Act
        var result = await _service.GetEffectiveReputations(
            _creatureId,
            [],
