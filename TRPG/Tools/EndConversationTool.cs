...
internal class EndConversationTool : Tool, IInvokableTool {
    ...
    public EndConversationTool(GameSession session, NpcConversationService npcConversationService,
        ...
        Function = new Function {
            ...
            Description = "Call this when a conversation with someone winds down or the topic changes significantly, to save a summary of what was discussed so you can recall it next time you speak with them.",
            Parameters = new Parameters {
                Type = "object",
                Properties = new Dictionary<string, Property> {
                    ["npcName"] = new() {
                        Type = "string",
                        Description = "The exact Name of the person you spoke with, copied verbatim from the most recent look or move result."
                    },
                    ["summary"] = new() {
                        Type = "string",
                        Description = "A concise, third-person, factual summary of what was discussed — replaces any previous summary for this person."
                    }
                },
    ...
    private async Task<object?> InvokeMethodAsync(string npcName, string summary, CancellationToken cancellationToken) {
        ...
        await _npcConversationService.SetSummary(_session.WorldId, _session.PlayerId, npcId, summary, cancellationToken);
