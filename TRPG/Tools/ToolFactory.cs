...
internal class ToolFactory(
    ...
    public IReadOnlyList<Tool> Create(GameSession session) => [
        ...
        new MoveTool(session, sceneService, personService, buildingService, locationService, lockService, loggerFactory.CreateLogger<MoveTool>()),
        ...
        new StartConversationTool(session, personService, npcConversationService, loggerFactory.CreateLogger<StartConversationTool>()),
