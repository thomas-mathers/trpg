...
// GetActiveGiveItemsObjectiveRecipientIdsQuery/GetActiveDeliverItemObjectiveRecipientIdsQuery.
public class GetActiveFreeCreatureObjectiveCreatureIdsQuery
{
    public required Guid WorldId { get; init; }
    public required Guid PlayerId { get; init; }
}

internal class GetActiveFreeCreatureObjectiveCreatureIdsQueryHandler(IQuestsDbContext context)
    : IQueryHandler<GetActiveFreeCreatureObjectiveCreatureIdsQuery, IReadOnlySet<Guid>>
{
    ...
    public async Task<IReadOnlySet<Guid>> Handle(
        GetActiveFreeCreatureObjectiveCreatureIdsQuery query,
