...
internal class GetQuestInteractionsForGiverQuery
{
...
internal record QuestConversationObjective(string Name, string Description, int RequiredAmount);

internal record QuestConversationDetail(
...
internal record QuestInteractionsForGiver(
