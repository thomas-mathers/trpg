...
{
    private readonly GetCreatureKnowledgeQueryHandler _getCreatureKnowledge;
    ...
    )
    {
        ...
        _getCreatureKnowledge = getCreatureKnowledge;
        _logger = logger;
    ...
    )
    {
        ...
        var askingPerson = await _getCreatureByNameNearby.Handle(
        ...
        var result = await _getCreatureKnowledge.Handle(query, cancellationToken);
