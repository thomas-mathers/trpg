...
[Collection("Database")]
public sealed class GetPropsByLocationIdQueryTests(DatabaseFixture db) : IAsyncLifetime
{
    private TrpgDbContext _context = null!;
    private ServiceProvider _serviceProvider = null!;
    private GetPropsByLocationIdQueryHandler _handler = null!;
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _handler = _serviceProvider.GetRequiredService<GetPropsByLocationIdQueryHandler>();
    ...
    public async Task Handle_ReturnsNonConnectorProps()
    {
        ...
        var result = await _handler.Handle(
            new GetPropsByLocationIdQuery { LocationId = room.LocationId },
