 ...
 */
export function handleGetTheftDetectionChance(response?: HandleGetTheftDetectionChanceResponse | HttpResponseResolver<{
    playerId: string;
}, GetTheftDetectionChanceData['body']>, options?: RequestHandlerOptions): HttpHandler {
    return http.post<{
        playerId: string;
    }, GetTheftDetectionChanceData['body']>(`${options?.baseUrl ?? '*'}/players/:playerId/theft-detection-chance`, info => {
        if (typeof response === 'function') {
            return response(info);
        }
        const body = response?.body;
...
export type HandleGetWorkstationInventoryResponse = {
    body: GetWorkstationInventoryResponses[200];
    status?: 200;
};

/**
 * Handler for the `GET /workstations/{workstationId}/inventory` operation.
 */
export function handleGetWorkstationInventory(response?: HandleGetWorkstationInventoryResponse | HttpResponseResolver<{
    workstationId: string;
}, never>, options?: RequestHandlerOptions): HttpHandler {
    return http.get<{
        workstationId: string;
    }, never>(`${options?.baseUrl ?? '*'}/workstations/:workstationId/inventory`, info => {
        if (typeof response === 'function') {
            return response(info);
        }
        const body = response?.body;
...
export type HandleReadBookPageResponse = {
    body: ReadBookPageResponses[200];
    status?: 200;
};

/**
 * Handler for the `POST /players/{playerId}/books/{itemId}/pages/{pageNumber}` operation.
 */
export function handleReadBookPage(response?: HandleReadBookPageResponse | HttpResponseResolver<{
    playerId: string;
    itemId: string;
    pageNumber: string;
}, never>, options?: RequestHandlerOptions): HttpHandler {
    return http.post<{
        ...
        itemId: string;
        pageNumber: string;
    }, never>(`${options?.baseUrl ?? '*'}/players/:playerId/books/:itemId/pages/:pageNumber`, info => {
        if (typeof response === 'function') {
            return response(info);
        }
        const body = response?.body;
...
export type HandleGetDeliverItemDialogResponse = {
    body: GetDeliverItemDialogResponses[200];
    status?: 200;
};
 ...
 */
export function handleGetDeliverItemDialog(response?: HandleGetDeliverItemDialogResponse | ToResponseUnion<GetDeliverItemDialogResponses> | HttpResponseResolver<{
    playerId: string;
}, never>, options?: RequestHandlerOptions): HttpHandler {
    return http.get<{
        playerId: string;
    }, never>(`${options?.baseUrl ?? '*'}/players/:playerId/deliver-item-dialog`, info => {
        if (typeof response === 'function') {
            return response(info);
        }
        const body = response?.body;
...
export type MswHandlerFactories = {
     ...
     * Handler for the `GET /workstations/{workstationId}/inventory` operation.
     */
    getWorkstationInventory: typeof handleGetWorkstationInventory;
    /**
     * Handler for the `POST /players/{playerId}/books/{itemId}/pages/{pageNumber}` operation.
     */
...
export function createMswHandlers(config: RequestHandlerOptions = {}): CreateMswHandlersResult {
    ...
    const all: CreateMswHandlersResult['all'] = (options = {}) => {
        ...
        return [
            ...
            invoke(pick.getTheftDetectionChance, overrides.getTheftDetectionChance),
            ...
            invoke(pick.getDeliverItemDialog, overrides.getDeliverItemDialog),
