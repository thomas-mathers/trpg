...
internal static class JobGenerator {
    ...
    public static Job GenerateSleep(Guid stateId, Guid personId, Guid roomId) => new() {
    ...
    public static Job GenerateIdle(Guid stateId, Guid personId, Guid? roomId) => new() {
    ...
    public static Job GenerateWork(Guid stateId, Guid personId, Guid roomId) => new() {
    ...
    public static IReadOnlyList<Job> Generate(
        Guid stateId, Guid personId, Guid sleepRoomId, Guid? workRoomId, Guid? idleRoomId
    ) {
        var jobs = new List<Job> { GenerateSleep(stateId, personId, sleepRoomId), GenerateIdle(stateId, personId, idleRoomId) };

        if (workRoomId != null) {
            jobs.Add(GenerateWork(stateId, personId, workRoomId.Value));
        }
