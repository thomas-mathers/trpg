...
import type { AcceptQuestData, AcceptQuestErrors, AcceptQuestResponses, AllocateCreatureAttributePointsData, AllocateCreatureAttributePointsResponses, BeginCaravanInteractionData, BeginCaravanInteractionResponses, BeginCreatureInteractionData, BeginCreatureInteractionResponses, CompleteQuestData, CompleteQuestErrors, CompleteQuestResponses, CompleteTradeData, CompleteTradeResponses, CreateSessionData, CreateSessionErrors, CreateSessionResponses, CreateWorldData, CreateWorldResponses, DropInventoryItemData, DropInventoryItemErrors, DropInventoryItemResponses, DropWorldData, DropWorldResponses, EndCaravanInteractionData, EndCaravanInteractionResponses, EndCreatureInteractionData, EndCreatureInteractionResponses, EquipCreatureItemData, EquipCreatureItemResponses, GetAbilitiesBySkillData, GetAbilitiesBySkillResponses, GetContainerInventoryData, GetContainerInventoryResponses, GetCreatureAbilitiesData, GetCreatureAbilitiesResponses, GetCreatureAttributePointsData, GetCreatureAttributePointsResponses, GetCreatureAttributesData, GetCreatureAttributesResponses, GetCreatureBaseAttributesData, GetCreatureBaseAttributesResponses, GetCreatureBasicAttackDamageData, GetCreatureBasicAttackDamageResponses, GetCreatureConsumablesData, GetCreatureConsumablesResponses, GetCreatureGenerationOptionsData, GetCreatureGenerationOptionsResponses, GetCreatureInventoryData, GetCreatureInventoryResponses, GetCreatureLevelData, GetCreatureLevelResponses, GetCreatureSkillsData, GetCreatureSkillsResponses, GetDeliverItemDialogData, GetDeliverItemDialogResponses, GetJobData, GetJobErrors, GetJobResponses, GetLocalMapData, GetLocalMapResponses, GetNearbyCorpsesData, GetNearbyCorpsesResponses, GetPlayerFightAbilitiesData, GetPlayerFightAbilitiesResponses, GetPlayerFightData, GetPlayerFightErrors, GetPlayerFightResponses, GetQuestDialogData, GetQuestDialogResponses, GetQuestJournalData, GetQuestJournalResponses, GetSessionItemData, GetSessionItemErrors, GetSessionItemResponses, GetSessionLoreAnchorData, GetSessionLoreAnchorErrors, GetSessionLoreAnchorResponses, GetSessionSceneData, GetSessionSceneErrors, GetSessionSceneResponses, GetSignTextData, GetSignTextErrors, GetSignTextResponses, GetTheftDetectionChanceData, GetTheftDetectionChanceErrors, GetTheftDetectionChanceResponses, GetTradeData, GetTradeResponses, GetWorkstationInventoryData, GetWorkstationInventoryResponses, GetWorldMapData, GetWorldMapResponses, ListSessionLoreAnchorsData, ListSessionLoreAnchorsResponses, ListWorldsData, ListWorldsResponses, PrefetchBookPageData, PrefetchBookPageErrors, PrefetchBookPageResponses, PrefetchDungeonPremisesData, PrefetchDungeonPremisesResponses, PreviewCreatureBasicAttackDamageData, PreviewCreatureBasicAttackDamageResponses, PreviewCreatureEquipmentData, PreviewCreatureEquipmentResponses, ProposeTradeData, ProposeTradeErrors, ProposeTradeResponses, ReadBookPageData, ReadBookPageErrors, ReadBookPageResponses, SetCreatureSneakingData, SetCreatureSneakingResponses, SetQuestTrackingData, SetQuestTrackingErrors, SetQuestTrackingResponses, TransferInventoryData, TransferInventoryErrors, TransferInventoryResponses, UnequipCreatureItemData, UnequipCreatureItemResponses } from './types.gen';
...
export const prefetchDungeonPremises = <ThrowOnError extends boolean = false>(options: Options<PrefetchDungeonPremisesData, ThrowOnError>): RequestResult<PrefetchDungeonPremisesResponses, unknown, ThrowOnError> => (options.client ?? client).post<PrefetchDungeonPremisesResponses, unknown, ThrowOnError>({
...
export const setCreatureSneaking = <ThrowOnError extends boolean = false>(options: Options<SetCreatureSneakingData, ThrowOnError>): RequestResult<SetCreatureSneakingResponses, unknown, ThrowOnError> => (options.client ?? client).put<SetCreatureSneakingResponses, unknown, ThrowOnError>({
...
export const getLocalMap = <ThrowOnError extends boolean = false>(options: Options<GetLocalMapData, ThrowOnError>): RequestResult<GetLocalMapResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetLocalMapResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/local-map', ...options });

export const endCreatureInteraction = <ThrowOnError extends boolean = false>(options: Options<EndCreatureInteractionData, ThrowOnError>): RequestResult<EndCreatureInteractionResponses, unknown, ThrowOnError> => (options.client ?? client).delete<EndCreatureInteractionResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/interactions/{creatureId}', ...options });

export const beginCreatureInteraction = <ThrowOnError extends boolean = false>(options: Options<BeginCreatureInteractionData, ThrowOnError>): RequestResult<BeginCreatureInteractionResponses, unknown, ThrowOnError> => (options.client ?? client).put<BeginCreatureInteractionResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/interactions/{creatureId}', ...options });

export const endCaravanInteraction = <ThrowOnError extends boolean = false>(options: Options<EndCaravanInteractionData, ThrowOnError>): RequestResult<EndCaravanInteractionResponses, unknown, ThrowOnError> => (options.client ?? client).delete<EndCaravanInteractionResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/caravans/{caravanId}/interaction', ...options });

export const beginCaravanInteraction = <ThrowOnError extends boolean = false>(options: Options<BeginCaravanInteractionData, ThrowOnError>): RequestResult<BeginCaravanInteractionResponses, unknown, ThrowOnError> => (options.client ?? client).put<BeginCaravanInteractionResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/caravans/{caravanId}/interaction', ...options });
...
export const dropInventoryItem = <ThrowOnError extends boolean = false>(options: Options<DropInventoryItemData, ThrowOnError>): RequestResult<DropInventoryItemResponses, DropInventoryItemErrors, ThrowOnError> => (options.client ?? client).post<DropInventoryItemResponses, DropInventoryItemErrors, ThrowOnError>({
...
export const getWorkstationInventory = <ThrowOnError extends boolean = false>(options: Options<GetWorkstationInventoryData, ThrowOnError>): RequestResult<GetWorkstationInventoryResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetWorkstationInventoryResponses, unknown, ThrowOnError>({ url: '/workstations/{workstationId}/inventory', ...options });

export const readBookPage = <ThrowOnError extends boolean = false>(options: Options<ReadBookPageData, ThrowOnError>): RequestResult<ReadBookPageResponses, ReadBookPageErrors, ThrowOnError> => (options.client ?? client).post<ReadBookPageResponses, ReadBookPageErrors, ThrowOnError>({ url: '/players/{playerId}/books/{itemId}/pages/{pageNumber}', ...options });

export const prefetchBookPage = <ThrowOnError extends boolean = false>(options: Options<PrefetchBookPageData, ThrowOnError>): RequestResult<PrefetchBookPageResponses, PrefetchBookPageErrors, ThrowOnError> => (options.client ?? client).post<PrefetchBookPageResponses, PrefetchBookPageErrors, ThrowOnError>({ url: '/books/{itemId}/pages/{pageNumber}/prefetch', ...options });
...
export const getQuestDialog = <ThrowOnError extends boolean = false>(options: Options<GetQuestDialogData, ThrowOnError>): RequestResult<GetQuestDialogResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetQuestDialogResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/quest-dialog', ...options });

export const getDeliverItemDialog = <ThrowOnError extends boolean = false>(options: Options<GetDeliverItemDialogData, ThrowOnError>): RequestResult<GetDeliverItemDialogResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetDeliverItemDialogResponses, unknown, ThrowOnError>({ url: '/players/{playerId}/deliver-item-dialog', ...options });

export const getSignText = <ThrowOnError extends boolean = false>(options: Options<GetSignTextData, ThrowOnError>): RequestResult<GetSignTextResponses, GetSignTextErrors, ThrowOnError> => (options.client ?? client).get<GetSignTextResponses, GetSignTextErrors, ThrowOnError>({ url: '/signs/{signId}', ...options });
