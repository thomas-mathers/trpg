...
public sealed class ResolveGuardEncounterActionCommandTests(DatabaseFixture db)
    : IAsyncLifetime,
        IClassFixture<DatabaseFixture>
{
    ...
    public async Task Handle_GoToJail_MovesThePlayerToTheCellsAndLocksTheExitUntilTheSentenceEnds()
    {
        ...
        Assert.Equal(GameClock.Epoch + TimeSpan.FromHours(10 + 24), updatedDoor.UnlocksAtGameTime);
    }
